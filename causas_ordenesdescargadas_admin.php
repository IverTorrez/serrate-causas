...
<html>
<head>
    <title>Causas Ordenes Descargadas ADMIN</title>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="85%">
            <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES DESCARGADAS DEL ADMINISTRADOR</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesdescargadascontadorDeAdmin();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*1234567;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_descargadas_admin.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
