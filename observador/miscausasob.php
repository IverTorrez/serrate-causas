    ...
    <div id="header">
        ...
        <div id="main_menu">
            ...
            <ul>
                ...
                <li class="first_list" ><a href="miscausasob.php" class="main_menu_first main_current">CAUSAS ACTIVAS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
                </li>
        ...
        <div id="portfolio_area">
            ...
            <?php
                ...
                <ul>
                    ...
                    <li><button class="botones" onclick="location.href='causasordenespronuncioabogado.php'" style="width: 160px; height: 55px;"><span id="contadores">&nbsp;&nbsp;<?php echo $fil7->Totalpronunabogado; ?>&nbsp;&nbsp;</span><br>7: PRONUNCIAMIENTO DEL ABOGADO </button></li> 

                   <li><button class="botones" style="width: 145px; height: 55px;" onclick="location.href='causasordenespronunciocontador.php'"><span id="contadores">&nbsp;&nbsp;<?php echo $fil8->Totalpronuncontador; ?>&nbsp;&nbsp;</span><br>8: CUENTAS CONCILIADAS </button></li>

                    
                </ul><br>
                 <ul>
                   <li><button class="botones" style="width: 170px; height: 55px;" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    <li><button class="botones" style="width: 250px; height: 55px;" onclick="location.href='causasvencidasgraves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil10->Totalvencidasgraves; ?>&nbsp;&nbsp;</span><br>VENCIDAS GRAVES</button></li>
                    
                    <li><button class="botones" style="width: 250px; height: 55px;" onclick="window.open('impresiones/pdf/causas_activas.php')">IMPRIMIR</button></li>
                   
                    <li style="float: right;">
                      <button style="height: 55px; margin-right: 4px; width: 145px;background: white;" class="botones" onclick="location.href='causas_ordenes_pre_presupuestadas.php'" ><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $filprepresu->Totalpre_presupuestadas; ?>&nbsp;&nbsp;</span> <img style="width: 65px; float: right;" src="../resources/imagenedesistema/Intermedio.png"></button>
                    </li>
...
<?php
/*IF QUE PREGUNTA SI SE SELECCIONO ALGUN SELECT*/
if (!isset($_POST['selectcodcausa']) and !isset($_POST['selectcodabogado']) and !isset($_POST['selectcodprocurador']) and !isset($_POST['selectcodcliente'])  ) 
{
echo "<script type='text/javascript'>
    $(document).ready(function(){
        // Añadimos un parámetro único a la URL para evitar el caché
        var url = 'consultacausasactivasobservador.php?nocache=' + new Date().getTime();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='fichacausaob.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a><br>";
...
}/*FIN DEL IF QUE PREGUNTA SI N SE A SELECCIONADO ALGUN SELECT*/

/*FUNCION AL SELECCIONAR UN TIPO LEGAL DE CAUSA DEL SELECT CODIGO DE CAUSA*/
     ...
     if ($fil->estadocausa=='Congelada') 
      {
       ...
       echo "<tr style='color: $colorcausa'>";
            ...
            $mascara=$fil->id_causa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a style='color: $colorcausa' href='fichacausaob.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a><br><br>";
              ...
              /*LISTAR ORDENES DE LA CAUSA*/
               ...
               {  /*FECHA Y HORA ACTUAL DE BOLIVIA*/
                  ...
                  $resultadoorden=$objneworden->mostrarfechayhorafin($filord->codorden);
                   ...
                   $mascara=$filord->codorden*10987654321;
                   $encriptada=base64_encode($mascara);
                 echo "<a style='color: $colorcausa' target='_blank' href='ordenob.php?squart=$encriptada'>$varcaraorden&nbsp; </a>";
        ...
        echo "</tr>";
          }/*FIN DEL LISTADO DE  LA CAUSAS ACTIVA*/
  
}/*FIN DEL IF QUE PREGUNTA SI SE SELECCIONO UNA CAUSA*/


/*FUNCION AL SELECCIONAR UN ABOGADO DEL SELECT PARA LISTAR SUS CAUSA*/
...
}/*FIN DEL IF QUE PREGUNTA SI SE SELECCIONO UN ABOGADO PARA LISTAR SUS CAUSAS ACTIVAS*/


/*FUNCION AL SELECCIONAR UN PROCURADOR DEL SELECT PARA LISTAR SUS CAUSA*/
...
}/*FIN DEL IF QUE PREGUNTA SI SE SELECCIONO UN procurador PARA LISTAR SUS CAUSAS ACTIVAS*/

/*FUNCION AL SELECCIONAR UN cliente DEL SELECT PARA LISTAR SUS CAUSA*/
...
}/*FIN DEL IF QUE PREGUNTA SI SE SELECCIONO UN cliente PARA LISTAR SUS CAUSAS ACTIVAS*/
  ?>
...
<!-- <script type="text/javascript">
    $(document).ready(function(){
       $('#tabla_resultadoActivos').load('consultacausasactivas.php');
    });

</script>
<script type="text/javascript">
 function funcionmessaje()
  {
    alert("olaaa");
  }
</script>-->
