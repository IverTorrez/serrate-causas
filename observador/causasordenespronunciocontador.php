...
<html>
<head>
    <title>Causas Con Ordenes Pronuncio Contador</title>
...
?>
                ...
                <ul>
                 ...
                 <ul>
                   <li><button class="botones" style="width: 170px; height: 55px;" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button class="botones" style="width: 250px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_pronunciocontador.php')">IMPRIMIR</button></li>
    ...
    <div class="container">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE CAUSAS CON ORDENES PRONUNCIADAS POR EL CONTADOR</h3>
    <br>
...
<tbody>
 <?php
   ...
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenespronunciadascontador();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='listaordenespronunciocontador.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
