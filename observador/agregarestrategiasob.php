...
include_once('../controller/control-addestrategiasob.php');
$cod=$_GET['squart'];
...
?>
  ...
  <div id="main_content">
    ...
    <div class="container">
    <h3  class="titulo">AGREGAR ESTRATEGIAS</h3>
    <br>
 ...
 <input type="hidden" name="idcausa" value="<?php echo $codigonuevo; ?>">
    ...
    <div class="orden">
      <textarea name="texteditorestrategia" cols="30" rows="5" class="tinymce" id="texteditorestrategia"><?php echo $fil->estrategias; ?></textarea>
    </div><br>

    <textarea style="display: none;" id="textestrategiasolotexto" name="textestrategiasolotexto"></textarea>
    <input type="submit" name="btnaddestrategias" onclick="escribirsolotexto()" value="GUARDAR" >
  </form>
<script type="text/javascript">
  function escribirsolotexto()
  {
    var estra= tinymce.get('texteditorestrategia').contentDocument.activeElement.innerText;
    
      $('#textestrategiasolotexto').val(estra);
  }
</script>
