                ...
                <ul>
                 ...
                 <ul>
                   <li><button class="botones" style="width: 170px; height: 55px;" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button class="botones" style="width: 250px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_listasrealizar.php')">IMPRIMIR</button></li>
...
<tbody>
 ...
 $codabog=$datos["id_abogado"];
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordeneslistasparadescargar();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='listaordeneslistaspararealizar.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
