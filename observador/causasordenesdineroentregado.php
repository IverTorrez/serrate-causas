...
<html>
<head>
    <title>Causas Con Ordenes Con Dinero Entregado</title>
...
?>
            ...
            <div id="portfolio_menu">
                ...
                <ul>
                 ...
                 <ul>
                    ...
                    <li><button class="botones" style="width: 250px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_dineroentregado.php')">IMPRIMIR</button></li>
    ...
    <div class="container">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE CAUSAS CON ORDENES CON DINERO ENTREGADO</h3>
    <br>
...
<tbody>
 <?php
 //$codabog=2; //ES EL CODIGO DE GUSTAVO, EL ABOGADO
 $codabog=$datos["id_abogado"];
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesdineroentregado();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='listaordenesdineroentregado.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
