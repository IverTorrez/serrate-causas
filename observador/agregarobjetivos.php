...
include_once('../controller/control-addobjetivosob.php');
$cod=$_GET['squart'];
...
?>
  ...
  <div id="main_content">
    ...
    <div class="container">
    <h3  class="titulo">AGREGAR OBJETIVOS</h3>
    <br>
 ...
 <input type="hidden" name="idcausa" value="<?php echo $codigonuevo; ?>">
    ...
    <div class="orden">
      <textarea  name="texteditorobjetivo" cols="30" rows="5" class="tinymce" id="texteditorobjetivo"><?php echo $fil->objetivos; ?></textarea>
    </div><br>

  <textarea style="display: none;" id="textobjetsolotexto" name="textobjetsolotexto"></textarea> 
    <input type="submit" name="btnaddobjetivos" onclick="escribirsolotexto()" value="GUARDAR" >
  </form>

 <script type="text/javascript">
  function escribirsolotexto()
  {
    var objet= tinymce.get('texteditorobjetivo').contentDocument.activeElement.innerText;
    
      $('#textobjetsolotexto').val(objet);
  }
</script>
