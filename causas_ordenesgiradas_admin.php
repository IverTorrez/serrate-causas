...
<html>
<head>
    <title>Causas Ordenes Giradas ADMIN</title>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="80%">
            <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES GIRADAS POR EL ADMINISTRADOR</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesgiradasDeAdmin();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*1234567; 
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_giradas_admin.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
