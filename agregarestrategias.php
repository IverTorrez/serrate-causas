...
include_once('controller/control-addestrategias.php');
$cod=$_GET['squart'];
...
?>
 ...
 <input type="hidden" name="idcausa" value="<?php echo $codigonuevo; ?>">
   ...
   <textarea style="display: none;" id="textestrategiasolotexto" name="textestrategiasolotexto"></textarea>
    ...
    <input type="submit" name="btnaddestrategias" onclick="escribirolotexto()" value="GUARDAR" >
  </form>

   <script type="text/javascript">
  function escribirolotexto()
  {
    var observ= tinymce.get('texteditorestrategia').contentDocument.activeElement.innerText;
    
      $('#textestrategiasolotexto').val(observ);
  }
</script>
</div>
    <br>
