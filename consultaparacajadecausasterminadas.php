 ...
 <h3 style="color: #000000;font-size: 30px;text-align: center; text-shadow: -2px -2px 5px #333">SALDOS DE LAS CAUSAS TERMINADAS</h3>
<table id="customers">
       <thead>
         <tr>
       ...
       <tbody>
        ...
        while ($fila=mysqli_fetch_object($resul)){
         ...
         <tr>
           <td colspan="2">SALDO TOTAL DE CAUSA TERMINADAS</td>
