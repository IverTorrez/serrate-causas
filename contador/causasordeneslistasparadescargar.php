...
<html>
<head>
    <title>Causas Con Ordenes Listas Para Descargar</title>
                ...
                <ul>
                 ...
                 <ul>
                  <li><button class="botones" style="width: 150px; height: 55px; " onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px; " onclick="window.open('impresiones/pdf/causas_ordenes_listasrealizar.php')">IMPRIMIR</button></li>
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='listaordenespararealizar.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
