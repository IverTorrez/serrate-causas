                ...
                <ul>
                 ...
                 <ul>
                  <li><button class="botones" style="width: 150px; height: 55px; " onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px; " onclick="window.open('impresiones/pdf/causas_ordenes_pronuncioabogado.php')">IMPRIMIR</button></li>
...
<div >
      <table width="100%">
        <tr>
          ...
          <td width="80%">
           <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES PRONUNCIADAS POR EL ABOGADO</h3>
          </td>
        </tr>
      </table>  
    </div>
