    ...
    <div id="main_content">
        ...
        <div id="portfolio_area">
            ...
            <div id="portfolio_menu">
                ...
                <ul>
                    <li><button class="botones" style="width: 300px; height: 45px;" onclick="location.href='contador_lista_ordenes.php?squart=<?php echo $codcausa ?>'" >LISTA DE ORDENES</button></li>
                    <li><button class="botones" style="width: 300px; height: 45px;" onclick="location.href='historigrama.php?squart=<?php echo $codcausa; ?>'" >VER HISTORIGRAMA</button></li>
                    <li><button class="botones" style="width: 300px; height: 45px;" onclick="window.open('impresiones/pdf/ficha.php?squart=<?php echo $codcausa; ?>')">IMPRIMIR FICHA</button></li>
                </ul>
                <br>
                <br>
