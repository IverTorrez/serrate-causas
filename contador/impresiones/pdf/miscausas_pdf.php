...
$pdf = new TCPDF('L', 'mm', 'LEGAL', true, 'UTF-8', false);/*PARA HOJA TAMAÑO LEGAL SE PONE LEGAL EN MAYUSCULA*/
...
<table border="0.1px">
	<thead>
	   <tr>
		...
		<th style="text-align:center; height: 20px; width:482px; background-color:#e8e8e8;">OBSERVACIONES</th>
		</tr>
	</thead>
...
<tr style="page-break-inside: avoid;">
   ...
   <td style="text-align:center; width:130px;">$filc[nombrecausa]</td>
   ...
   <td style="text-align:center; width:482px;">$filc[Observ]</td>
</tr>
