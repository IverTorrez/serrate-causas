...
<html>
<head>
    <title>Lista Ordenes Presupuestadas</title>
...
?>
  ...
  <input type="hidden" name="" value="<?php echo $codigonuevo ?>">
   <section class="responsive">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTA DE ORDENES PRESUPUESTADAS</h3>
    <br>
    <!--TABLA 1-->
...
<?php
   ...
   $resul=$objorden->listarordenespresupuestadasdeunacausa($codigonuevo);
