...
<html>
<head>
    <title>Lista Ordenes Aceptadas</title>
...
?>
  ...
  <input type="hidden" name="" value="<?php echo $codigonuevo ?>">
   <section class="responsive">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTA DE ORDENES ACEPTADAS</h3>
    <br>
    <!--TABLA 1-->
...
<section class="responsive">
 ...
 <thead>     
  <tr>
    ...
    <th width="200px">PROCURADOR <br><p id="psubt">(GESTOR)</p></th>
    <th width="100px">PRONUNCIAMIENTO DEL ABOGADO</th>
...
<?php
   ...
   $resul=$objorden->listarordenesaceptadasdeunacausa($codigonuevo);
          ...
          if ($fecha1>$fecha2) {
            ...
            $msm='hay vigencia';
             ...
             ////////CODIGO QUE MUESTRA LA FECHA DE DESCARGA DE UNA ORDEN
              ...
              $resultor1=$objorden1->mostrarfechaypronuncionabogado($fil->codigo);
              $filab=mysqli_fetch_object($resultor1);
              if ($filab->fechaabog=='') {
                echo "<td></td>";
              }
              else
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <label><b>Esta seguro de eliminar esta nota de agenda ??</b></label><br><br>
