...
<html>
<head>
    <title>Lista Ordenes Vencidas Leves</title>
...
<?php
 ...
 $concat=$fechoyal.' '.$horita;
   ...
   $resul=$objorden->mostrarOrdenVencidasLevesDeCausaAbog($codigonuevo);
       ...
       if ($fecha1>$fecha2) 
       {
        ...
        //SE ENCRIPTA EL CODIGO DE LA ORDEN PARA ENVIARLO POR LA URL //
            ...
            //  echo "<td>$fil->Costoproccompra</td>";  //dato no hay aun, este dato depende de si es suficiente la orden
              ...
              $resultor1=$objorden1->mostrarfechaypronuncionabogado($fil->Codorden);
