...
include_once('../controller/control-apuntesjuridicos.php');
$cod=$_GET['squart'];
...
?>
  ...
  <div id="main_content">
    ...
    <div class="container">
    <h3  class="titulo">AGREGAR APUNTES JURIDICOS</h3>
    <br>
 ...
 <input type="hidden" name="idcausa" value="<?php echo $codigonuevo; ?>">
    ...
    <div class="orden">
      <textarea name="texteditorapuntjurid" cols="30" rows="5" class="tinymce" id="texteditorapuntjurid"><?php echo $fil->apuntesjuridicos; ?></textarea>
    </div><br>

   <textarea style="display: none;" id="textapuntejurisolotexto" name="textapuntejurisolotexto"></textarea>
    <input type="submit" name="btnaddapuntjuri" onclick="escribirsolotexto()" value="GUARDAR" >
  </form>

<script type="text/javascript">
  function escribirsolotexto()
  {
    var apuntjur= tinymce.get('texteditorapuntjurid').contentDocument.activeElement.innerText;
    
      $('#textapuntejurisolotexto').val(apuntjur);
  }
</script>
