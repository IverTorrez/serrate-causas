...
<html>
<head>
    <title>Lista Ordenes Giradas</title>
...
?>
  ...
  <input type="hidden" name="" value="<?php echo $codigonuevo; ?>">
   <section class="responsive">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTA DE ORDENES GIRADAS</h3>
    <br>
    <!--TABLA 1-->
...
<?php
 ...
 ini_set('date.timezone','America/La_Paz');
   ...
   $resul=$objorden->listarordenesgiradasdeunacausa($codigonuevo);
