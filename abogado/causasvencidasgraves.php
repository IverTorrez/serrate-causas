            ...
            <div id="portfolio_menu">
                ...
                <ul>
                 ...
                 <ul>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_vencidasgraves_imp.php')">IMPRIMIR</button></li>
...
<tbody>
 ...
 }/*FIN DEL WHILE QUE RRECORRE LAS ORDENES SIN DESCARGADAS VENCIDAS GRAVES*/
 ...
 if (count($arrayIdCausas)>0) 
 {
   ...
   { 
     ...
     $objcausa1=new Causa();
     $resultcausa=$objcausa1->mostrarUnacausaDeAbogado($idcausa1,$codabog);
