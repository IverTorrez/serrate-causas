...
//include_once('../controller/control-orden.php');
...
<!--<form action="" method="POST" id="frmcrearorden">-->

<input type="hidden" name="textidcausa"  id="textidcausa" value="<?php echo $codigonuevo; ?>">
<b><h3 class="titulo">CARGA DE INFORMACIÓN Y DOCUMENTACIÓN </h3></b><br>
...
<script type="text/javascript">
 /* $(document).ready(function(){
    ...
    $('#btnguardarorden').click(function(){
       var datos=$('#frmcrearorden').serialize();
       // $textarea=$('#textcodencripcausa').val();

      var horariov=document.getElementById("texteditorinformacion").value;
       
     /*  if ($('#texteditorinformacion').text()!='' && $('#texteditordocum').text()!='' ) 
       {*/

          /* $.ajax({
            type:"post",
            url:"../controller/control-regordenajax.php",
            data:datos,
            success:function(respuesta){
              ...
              {
                setTimeout(function(){  }, 2000); swal(horariov,'No Se Creo El Piso','warning');
              }
              $('#textpiso').val('');
            }
          });
...
/*MANDAMOS AL CONTROLADOR , EL lugar_ejecucion======================*/
          ...
          axios.post("../controller/control-regordenajax.php?accion=crear",cadena)
