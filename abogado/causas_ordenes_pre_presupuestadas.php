            ...
            <div id="portfolio_menu">
                ...
                <ul>
                 ...
                 <ul>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_presupuestadas_imp.php')">IMPRIMIR</button></li>
...
<tbody>
 ...
 $codabog=$datos['id_abogado'];
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesPre_presupuestadasDeAbogado($codabog);
