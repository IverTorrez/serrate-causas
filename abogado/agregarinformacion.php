...
<html>
<head>
    <title>Apuntes Informacion</title>
...
include_once('../controller/control-addinformacion.php');
$cod=$_GET['squart'];
...
?>
  ...
  <div id="main_content">
    ...
    <div class="container">
    <h3  class="titulo">AGREGAR OTRA INFORMACION</h3>
    <br>
 ...
 <input type="hidden" name="idcausa" value="<?php echo $codigonuevo; ?>">
    ...
    <div class="orden">
      <textarea name="texteditorinformacion" cols="30" rows="5" class="tinymce" id="texteditorinformacion"><?php echo $fil->informacion; ?></textarea>
    </div><br>

    <textarea style="display: none;" id="textotrainforsolotexto" name="textotrainforsolotexto"></textarea>


    <input type="submit" name="btnaddinformacion" onclick="escribirsolotexto()" value="GUARDAR" >
  </form>
  ...
  {
    var otrainfor= tinymce.get('texteditorinformacion').contentDocument.activeElement.innerText;
    
      $('#textotrainforsolotexto').val(otrainfor);
  }
</script>
