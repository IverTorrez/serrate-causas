...
<html>
<head>
    <title>Causas Con Ordenes Pronunciadas Abogado</title>
            ...
            <div id="portfolio_menu">
                ...
                <ul>
                 ...
                 <ul>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_pronunciadasabogado_imp.php')">IMPRIMIR</button></li>
...
<tbody>
 ...
 $codabog=$datos["id_abogado"];
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasDeAbogadoConOrdenesPronunciadasAbogado($codabog); 
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='listaordenespronunciadasabogado.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
