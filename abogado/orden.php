...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../resources/menu_sin_estilo_listas.css">
...
?>
    ...
    <div id="header">
        ...
        <div id="main_menu">
            ...
            <ul id="ul-menu">
               <li  class="first_listleft" style="float: left; width: 600px; margin-right: 340px;"><a >USUARIO:<?php echo $datos['nombreabog']; ?>  TIPO:Abogado</a></li>
                
                <li id="li-menu" class="first_list" ><a href="miscausas.php" class="main_menu_first ">CAUSAS ACTIVAS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
                </li>
                
                <li id="li-menu" class="first_list" ><a href="../cerrarSesion.php" class="main_menu_first">SALIR</a></li>
            </ul>
        ...
        <div id="portfolio_area">
            ...
            <div id="portfolio_menu">
              ...
              ?>
                ...
                <ul id="ul-portsfolio">
                    <li id="li-porta"><button class="botones" style="width: 200px; height: 45px;" onclick="location.href='fichacausa.php?squart=<?php echo $encriptado; ?>'">FICHA</button></li>
                    <li id="li-porta"><button class="botones" style="width: 200px; height: 45px;" onclick="location.href='listaorden.php?squart=<?php echo $encriptado; ?>'">LISTA DE ORDENES</button></li>
                     ...
                     if ($filatipo->tipoorden=='Normal') 
                     {
                          ...
                          if (($filaorden->estado_orden=='Descargada' or $filaorden->estado_orden=='PronuncioContador') and $filaorden->fechaconfabogado=='' and $filaorden->idabogado==$idabogado) 
                          {
                            ...
                            <button class="botones" id="myBtnformacep" name="" style="width: 200px; height: 45px;">APROBAR</button>
                            </li>
