    ...
    <div id="main_content">
        ...
        <div id="portfolio_area">
            ...
            <div id="portfolio_menu">
                ...
                <ul>
                    <li><button class="botones" style="width: 200px;height: 45px;" onclick="location.href='fichacausa.php?squart=<?php echo $codcausa; ?>'">FICHA</button></li>
                    <li><button class="botones" style="width: 200px; height: 45px;" onclick="location.href='listaorden.php?squart=<?php echo $codcausa; ?>'"> LISTA ORDENES </button></li>
