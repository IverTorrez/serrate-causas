            ...
            <div id="portfolio_menu">
                ...
                <ul>
                 ...
                 <ul>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_vencidasleves_imp.php')">IMPRIMIR</button></li>
...
$codabog=$datos['id_abogado'];
 ...
 $resulorden=$objorde->mostrarfechafinalyCodCausaDeAbogadoVencidosLeves($codabog);
