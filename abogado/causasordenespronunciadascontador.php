...
<html>
<head>
    <title>Causas Con Ordenes Pronunciadas Contador</title>
              ...
              <?php
                ...
                <ul>
                 ...
                 <ul>
                    ...
                    <li><button class="botones" style="width: 145px; height: 55px;" onclick="window.open('impresiones/pdf/causas_ordenes_conciliadas_imp.php')">IMPRIMIR</button></li>
...
<tbody>
 ...
 $codabog=$datos["id_abogado"];
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasDeAbogadoconordenespronunciadascontador($codabog); 
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='listaordenespronunciadascontador.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
