...
$abogadonombre=$datos['nombreabog'];
        ...
        $pdf->Cell(250, 0, '                                                                                    LISTADO DE CAUSAS CON ORDENES CONCILIADAS POR EL CONTADOR', 0, 0, 'C', 0, '', 0);
...
$idabogadoactual=$datos['id_abogado'];  //ES EL CODIGO DE GUSTAVO, EL ABOGADO
   ...
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasDeAbogadoconordenespronunciadascontador($idabogadoactual);
...
$pdf->Output('CausasOrdenesConciliadas.pdf');
?>