...
<table border="0.1px">
	<thead>
	   <tr>
		<th style="text-align:center; width:150px; background-color:#e8e8e8;">CODIGO</th>
		<th style="text-align:center; width:250px; background-color:#e8e8e8;">NOMBRE DEL PROCESO</th>
		<th style="text-align:center; width:170px; background-color:#e8e8e8;">ABOGADO</th>
		<th style="text-align:center; width:170px; background-color:#e8e8e8;">CLIENTE</th>
		<th style="text-align:center; width:165px; background-color:#e8e8e8;">PROCURADOR <br>(por defecto)</th>
...
<tr style="page-break-inside: avoid;">
   <td style="text-align:center; width:150px;">$fil[codigo]</td>
   <td style="text-align:center; width:250px;">$fil[nombrecausa]</td>
   <td style="text-align:center; width:170px;">$fil[abogadogestor]</td>
   <td style="text-align:center; width:170px;">$fil[clienteasig]</td>
   <td style="text-align:center; width:165px;">$fil[procuradorasig]</td>
...
<table border="0.1px">
<tr style="page-break-inside: avoid;">
   <td style="text-align:center; width:60px;">$fil[tptribu]</td>
   <td style="text-align:center; width:185px;">$fil[juzg]</td>
   <td style="text-align:center; width:50px;">$fil[Pis]</td>
   <td style="text-align:center; width:70px;">$fil[expediente]</td>
   <td style="text-align:center; width:80px;">$fil[codnurejianuj]</td>
   <td style="text-align:center; width:115px;">$fil[cont1]</td>
   <td style="text-align:center; width:115px;">$fil[cont2]</td>
   <td style="text-align:center; width:115px;">$fil[cont3]</td>
   <td style="text-align:center; width:115px;">$fil[cont4]</td>
</tr>
...
$pdf->Cell(0, 0, '', 0, 1, 'C', 0, '', 0);/*COLUMNA BACIA PARA QUE EVITE QUE LA FILA SE BYA HACIA LA IZQUIERDA Y NO RESPETE LOS MARGENES*/
