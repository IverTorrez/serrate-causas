...
$abogadonombre=$datos['nombreabog'];
      //  $pdf->Image('images/logoserrate3.jpg',10, 10, 70, 15, '', '', '', false, 300, '', false, false, 0, false, false, false);
        ...
        $pdf->Cell(250, 0, '                                                                                    LISTADO DE CAUSAS CON ORDENES CON LISTAS PARA REALIZAR', 0, 0, 'C', 0, '', 0);
...
$idabogadoactual=$datos['id_abogado'];  //ES EL CODIGO DE GUSTAVO, EL ABOGADO
   ...
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasDeAbogadoconordeneslistasparadescargar($idabogadoactual);
...
$pdf->Output('CausasOrdenesListasParaRealizar.pdf');
?>