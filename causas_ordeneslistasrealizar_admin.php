...
<html>
<head>
    <title>Causas Ordenes Listas para descargar ADMIN</title>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="85%">
            <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES LISTAS PARA REALIZAR DEL ADMINISTRADOR</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
    $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordeneslistasparadescargarDeAdmin();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*1234567;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_listasrealizar_admin.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
