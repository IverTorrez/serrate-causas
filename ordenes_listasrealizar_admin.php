...
<html>
<head>
    <title>Lista de Ordenes Listas Para Realizar ADMIN</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES LISTAS PARA REALIZAR DE ADMINISTRADOR</h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesDeAdminListasParaDescargarDeunaCausa($codigonuevo);
