...
<html>
<head>
    <title>Causas Ordenes Aceptadas</title>
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*1234567;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_aceptadas.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
