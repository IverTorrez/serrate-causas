    ...
    <div id="main_content">
        ...
        <div id="portfolio_area">
            ...
            <div id="portfolio_menu">
                ...
                <ul>
                    <li><button style="font-size: 12px; width: 300px; height: 45px;" onclick="location.href='creartribunal.php'" class="botones">CREAR NUEVO TRIBUNAL</button></li>
                    <li><button style="font-size: 12px; height: 45px;" class="botones" onclick="window.open('impresiones/pdf/tribunales.php')">IMPRIMIR</button></li>
   ...
   while ($fil=mysqli_fetch_object($resul)) {
       echo "<tr>";
             ...
             $encriptado1=base64_encode($mascarac);
              echo "<td><a href='creartribunal.php?squart=$encriptado1'><i class='fa fa-edit fa-2x' aria-hidden='true'></i></a></td>";
