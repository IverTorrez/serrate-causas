...
<html>
<head>
    <title>Lista de Ordenes Pronunciadas Abogado ADMIN</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES DEL ADMINISTRADOR, PRONUNCIADAS POR EL ABOGADO </h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesDeAdminPronunciadasAbogadoDeunaCausa($codigonuevo);
