...
<html>
<head>
    <title>Causas Ordenes Pronunciadas Abogado</title>
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*1234567;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_pronunciadas_abogado.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
