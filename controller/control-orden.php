  ...
  //PREGUNTA EL TOTAL DE LAS HORAS DE CADA ORDEN
    ...
    if ($objorden->guardarorden()) {
      ...
      if ($objcotiz->guardarcotizacion()) {
        echo "<script > setTimeout(function(){ location.href='listaorden.php?squart=$encriptado'; }, 500); swal('EXELENTE','Se Giro La Orden Con Exito ','success'); </script>";
      }
      else{
        echo "<script > setTimeout(function(){  }, 2000); swal('ERROR',' No Se Giro La Orden ','warning'); </script>";
      }
