...
/*---------------------FIN DEL ENVIO DE CORREO-----------------------------------------------------------*/
    ...
    }/*FIN DEL IF QUE PREGUNTA SI LA FECHA DE PRONUNCIAMIENTO ESTA VACIA*/
    /*else que se ejecuta al ver que la fecha no esta vacia (pronuncio el admin)*/
    else
    {
      echo "<script > setTimeout(function(){ }, 2000); swal('ATENCION','El Administrador ya hizo el pronunciamiento a la descarga','warning'); </script>";
    }
...
/*---------------------FIN DEL ENVIO DE CORREO-----------------------------------------------------------*/
  ...
  }/*FIN DEL IF QUE PREGUNTA SI ESTA VACIA LA FECHA DE PRONUNCIAMIENTO ABOGADO*/
   else
   {
    echo "<script > setTimeout(function(){ }, 2000); swal('ATENCION','El Administrador ya hizo el pronunciamiento a la descarga','warning'); </script>";
   }
