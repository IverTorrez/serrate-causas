...
} /*FIN DE LA FUNCION REGISTAR JUZGADO O TRIBUNAL*/

function EditarJuzgadotribunal()
{
	...
	}/*FIN DEL ESLE QUE SE EJECUTA AL SELECCIONAR FOTO*/

}/*FIN DE LA FUNCION EditarJuzgadotribunal*/

function darbajatribunal()
{
