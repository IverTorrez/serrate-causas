...
/*------------ENVIO DE CORREO AL CLIENTE-------------------------------------------------*/
                           ...
                           /*NUEVOS CODIGOS PARA EL CORREO*/
                           $nombreCliente=$filcli->nombrecli." ".$filcli->apellidocli;

                           $asunto="COMPROBANTE DE TRANSFERENCIA DE SALDOS";
                           $mensajedecorreo="$senior $nombreCliente \n";
                           $mensajedecorreo.="Informamos a usted, que se ha transferido el monto de $montotranfer bolivianos de su causa con $codigo1 $codigocausaorigen de nombre $nombreorigen, a su otra causa de $codigo1 $codigocausadestino de nombre $nombredestino.\n ";
                           $mensajedecorreo.="Como resultado se tiene que: \n";

                           $mensajedecorreo.="La causa de $codigo1 $codigocausaorigen de nombre $nombreorigen, ahora tiene un saldo de $nuevacajaorigen bolivianos; y, la causa de $codigo1 $codigocausadestino de nombre $nombredestino, ahora tiene un saldo de $nuevacajadestino. \n";
