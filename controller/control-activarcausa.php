...
function enviarCorreoDescongelarCausa()
{   /*Se obtiene los datos de la planilla con codigo 20*/
      $objplanilla= new Planillas_envio_notificacion();
      $resulplanilla=$objplanilla->mostrarUnaPlanillas_envioNotif_activa(20);
