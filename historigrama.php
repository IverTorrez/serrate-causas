...
include_once('controller/control-eliminarhistorigrama.php');
        ...
        <div id="portfolio_area">
            ...
            <div class="container">
             ...
             <div id="portfolio_menu">
                ...
                <ul>
                  <li><button style="width: 200px;" class="botones" onclick="funcionllevaidcausamodalelim(<?php echo $codigonuevo; ?>);">ELIMINAR HISTORIGRAMA</button></li>
                  
                  <li><button style="width: 200px;" class="botones" onclick="window.open('impresiones/tcpdf/pdf/impresion_historigrama.php?codcausa=<?php echo $cod ?>')" >IMPRESION PDF</button></li>
...
<!--******************MODAL PARA ELIMINAR UN HISTORIGRAMA**************************************-->
 <script type="text/javascript">
 //FUNCION QUE LEVANTA EL MODAL Y EL ID DE LA CAUSA PARA ELIMINAR EL HISTORIGRAMA
  function funcionllevaidcausamodalelim(idd)
  {
    $('#textidCausa').val(idd);
    var modal = document.getElementById("myModalelim");
    var btnclose = document.getElementById("btncloseformpreselim");
    var span = document.getElementById("spanclosepreselim");
    ...
    btnclose.onclick=function() {
      modal.style.display = "none";
         ...
         <!-- The Modal (FORMULARIO) PARA ELIMINAR UN HISTOGRAMA -->
<div id="myModalelim" class="modal">

  <!-- Modal content -->
  <div class="modal-content" style="width: 550px;">
    <div class="modal-header">
      <span class="close" id="spanclosepreselim">&times;</span><br>
      
      <h2 style="font-style: italic; ">SERRATE 3.0</h2>
    </div>
     <div><br>
      <center> <p id="titlusent" style="font-size: 20px;font-family: fantasy;" >ESTA SEGURO DE ELIMINAR ESTE HISTORIGRAMA??</p></center>
     
     </div><br>
    <form method="post">
      <input type="hidden" name="textidCausa" id="textidCausa" placeholder="id causa">
    ...
    <div class="modal-footer">
     <button type="submit" class="btnclose" id="btnelimihistorigrama" name="btnelimihistorigrama" style="">ELIMINAR</button>

     
     <button type="button" class="btnclose" id="btncloseformpreselim" style="float: right;">Cancelar</button>
     </div>
      </form>
