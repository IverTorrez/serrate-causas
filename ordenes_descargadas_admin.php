...
<html>
<head>
    <title>Lista de Ordenes Descargadas ADMIN</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES DESCARGADAS DEL ADMINISTRADOR</h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesDeAdminDescargadasDeunaCausa($codigonuevo);
