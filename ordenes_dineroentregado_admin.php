...
<html>
<head>
    <title>Lista de Ordenes Dinero Entregado ADMIN</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES CON DINERO ENTREGADO DEL ADMINISTRADOR</h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesDeAdmin_DineroEntregadoDeunaCausa($codigonuevo);
