<?php require_once('../../Modelos/clsconexion.php'); ?>
<?php
$query_usuario= "SELECT *FROM usuario  ORDER BY nombresusu ";
$usuario= mysqli_query($cnx, $query_usuario) or die(mysqli_error());
