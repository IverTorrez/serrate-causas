...
<html>
<head>
    <title>Causas Ordenes Pronunciadas Contador ADMIN</title>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="85%">
           <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES CON CUENTAS CONCILIADAS DEL ADMINISTRADOR</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenespronunciadascontadorDeAdmin();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*1234567;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_cuentas_conciliadas_admin.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
