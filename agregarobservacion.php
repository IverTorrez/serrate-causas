...
include_once('controller/control-addobservacion.php');
$cod=$_GET['squart'];
...
?>
 ...
 <input type="hidden" name="idcausa" value="<?php echo $codigonuevo; ?>">
   ...
   <textarea style="display: none;" id="textareaobssolotexto" name="textareaobssolotexto"></textarea>

    <input  type="submit" name="btnaddobserv" onclick="escribirobservacionsolotexto()" value="GUARDAR" >
  </form>
...
<script type="text/javascript">
  function escribirobservacionsolotexto()
  {
    var observ= tinymce.get('texteditorobserv').contentDocument.activeElement.innerText;
    
      $('#textareaobssolotexto').val(observ);
  }
</script>
    <br>
    <br>
