            ...
            <div id="portfolio_menu">
                ...
                <ul>
                  ...
                  <li><button style="height: 55px; width: 150px; " class="botones" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button style="height: 55px;width: 145px; " class="botones" onclick="window.open('impresiones/pdf/causas_ordenes_pronuncioContador.php')">IMPRIMIR</button></li>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="80%">
          <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES PRONUNCIADAS POR EL CONTADOR</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
   ...
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesDeProcuradorpronunciadascontador($idprocuradoractual);
       ...
       echo "<tr>";
            ...
            $mascara=$fil->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenespronunciadascontador.php?squart=$encriptado' onclick=funcionirficha($fil->idcausa)>$fil->codigo</a></td>";
