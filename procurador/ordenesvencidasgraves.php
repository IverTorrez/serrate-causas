...
<html>
<head>
    <title>Lista Ordenes Vencidas Graves</title>
    ...
    <div id="main_content">
        ...
        <div id="portfolio_area">
            ...
            <div id="portfolio_menu">
                 ...
                 <ul>
                    <li><button style="height: 45px;" class="botones" onclick="location.href='ficha.php?squart=<?php echo $encriptado1; ?>'">VOLVER A LA FICHA</button></li>   
                </ul>       
                <br>
                <br>
...
<tbody>
 ...
 $concat=$fechoyal.' '.$horita;
   ...
   $resul=$objorden->mostrarOrdenesDeProcuradorVencidasGravesDeCausa($codigonuevocausa,$idproc);
        ...
        //SE ENCRIPTA EL CODIGO DE LA ORDEN PARA ENVIARLO POR LA URL //
            $mascara=$fil->Codorden*1020304050;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='orden.php?squart=$encriptado'>$fil->Codorden</a></td>";
