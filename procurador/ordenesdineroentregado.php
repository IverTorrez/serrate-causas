...
<html>
<head>
    <title>Lista Ordenes Con Dinero Entregado</title>
...
<!--TABLA LISTA DE ORDENES PROCURADOR-->
    <div class="container">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES CON DINERO ENTREGADO</h3>
...
<tbody>
 ...
 ini_set('date.timezone','America/La_Paz');
   ...
   $resul=$objorden->listarordenesdineroentregadodeunacausaDeUnProcuradorparaprocuradores($codigonuevocausa,$idproc);
