            ...
            <div id="portfolio_menu">
                ...
                <ul>
                   ...
                   <li><button style="height: 55px; width: 150px; " class="botones" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button style="height: 55px;width: 145px; " class="botones" onclick="window.open('impresiones/pdf/causas_ordenes_dineroentregado.php')">IMPRIMIR</button></li>
                </ul>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="75%">
           <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES CON DINERO ENTREGADO</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
   ...
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesdineroentregadoDeProcurador($idprocuradoractual);
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenesdineroentregado.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
