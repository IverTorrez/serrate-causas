...
<html>
<head>
    <title>Lista Ordenes Descargadas</title>
...
<!--TABLA LISTA DE ORDENES PROCURADOR-->
    <div class="container">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES DESCARGADAS</h3>
...
<tbody>
 ...
 $idproc=$datos['id_procurador'];  //id_procurador CODIGO DEL PROCURADOR
  ...
  ini_set('date.timezone','America/La_Paz');
   ...
   $resul=$objorden->listarordenesdescargadasDeProcuradorDeunacausaparaprocuradores($codigonuevocausa,$idproc);
