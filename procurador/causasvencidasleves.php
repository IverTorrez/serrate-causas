            ...
            <div id="portfolio_menu">
                ...
                <ul>
                  ...
                  <li><button style="height: 55px; width: 150px; " class="botones" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button style="height: 55px;width: 145px; " class="botones" onclick="window.open('impresiones/pdf/causas_ordenes_vencidasleves.php')">IMPRIMIR</button></li>
                </ul>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="75%">
          <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES VENCIDAS LEVES</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 ...
 $resulorden=$objorde->mostrarfechafinalyCodCausaDeOrdenesDeProcuradorVencidosLeves($idprocuradoractual);
      ...
      echo "<tr>";
            ...
            $mascara=$filcausa->idcausa*12345678910;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenesvencidasleves.php?squart=$encriptado'>$filcausa->codigo</a></td>";
