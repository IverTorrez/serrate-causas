...
$idprocuradoractual=$_GET['codproc'];
 $objcausa=new Causa();
       ...
       echo "<tr height: 300px; style='color: $colorcausa'>";
          //ENCRIPTACION DE CODIGO DE LA CAUSA PARA ENVIARLA POR LA URL
             ...
             $encriptado1=base64_encode($mascarac);
              echo "<td class='tdcod'><a style='color: $colorcausa' href='ficha.php?squart=$encriptado1' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a><br>";
