            ...
            <div id="portfolio_menu">
                ...
                <ul>
                  ...
                  <li><button style="height: 55px; width: 150px; " class="botones" onclick="location.href='causasvencidasleves.php'"><span id="contadoresvencidos">&nbsp;&nbsp;<?php echo $fil9->Totalvencidasleves; ?>&nbsp;&nbsp;</span><br>VENCIDAS LEVES</button></li>
                    ...
                    <li><button style="height: 55px;width: 145px; " class="botones" onclick="window.open('impresiones/pdf/causas_ordenes_descargadas.php')">IMPRIMIR</button></li>
                </ul>
...
<tbody>
 <?php
   ...
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesdescargadasDeUnProcurador($idprocuradoractual);
