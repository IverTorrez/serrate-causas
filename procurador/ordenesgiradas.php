...
<!--TABLA LISTA DE ORDENES PROCURADOR-->
    <div class="container">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES GIRADAS</h3>
...
<tbody>
 ...
 ini_set('date.timezone','America/La_Paz');
   ...
   $resul=$objorden->listarordenesgiradasdeunacausaparaUnProcuradores($codigonuevocausa,$idproc);
