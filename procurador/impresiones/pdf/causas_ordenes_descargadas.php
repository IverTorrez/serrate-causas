...
$idprocuradoractual=$datos['id_procurador'];
        ...
        $pdf->Cell(250, 0, '                                                                                       LISTADO DE CAUSAS CON ORDENES DESCARGADAS', 0, 0, 'C', 0, '', 0);
...
$pdf->writeHTML($bloque1,false,false,false,false,'');
  ...
  $objcausa=new Causa();
  $resulcausa=$objcausa->listarcausasconordenesdescargadasDeUnProcurador($idprocuradoractual);
...
$nameFile='CausaOrdenesDescargadas.pdf';
$pdf->Output($nameFile);
