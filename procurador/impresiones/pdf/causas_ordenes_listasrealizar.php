...
$idprocuradoractual=$datos['id_procurador'];
        ...
        $pdf->Cell(250, 0, '                                                                                       LISTADO DE CAUSAS CON ORDENES LISTAS PARA REALIZAR', 0, 0, 'C', 0, '', 0);
...
$pdf->writeHTML($bloque1,false,false,false,false,'');
  ...
  $objcausa=new Causa();
  $resulcausa=$objcausa->listarcausasconordeneslistasparadescargarDeProcurador($idprocuradoractual);
...
$nameFile='CausaOrdenesListasparaRealizar.pdf';
$pdf->Output($nameFile);
