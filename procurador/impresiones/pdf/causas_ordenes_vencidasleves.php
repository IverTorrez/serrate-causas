...
$idprocuradoractual=$datos['id_procurador'];
        ...
        $pdf->Cell(85, 0, 'Procurador: '.$nombreprocu, 0, 1, 'R', 0, '', 1);
...
<tr style="page-break-inside: avoid;" nobr="true">
   ...
   <th style="text-align:center; width:80px;">$filcausa[Categ]</th>
...
$nameFile='CausaOrdenesVencidasLeves.pdf';
$pdf->Output($nameFile);
