...
$pdf->Ln(12);
/*===============================================================
TAMAÑO TOTAL DE LA HOJA OFICIO ECHADA(ORIZONTAL)=902px DISPONIBLE PARA OCUPAR CON DATOS, RESPETANDO LOSMARGENES ESTABLECIDOS POR CODIGO EN LA FUNCION ->SetMargins(34, 30 ,2.5)
/*===============================================================*/
$pdf->SetFont('','',8);
$bloque1=<<<EOF
...
<table border="0.1px">
    ...
    <th style="text-align:center;  width:185px; background-color:#e8e8e8;">OBSERVACIONES DE LA CAUSA</th>
...
<tr style="page-break-inside: avoid;" nobr="true">
   <th style="text-align:center; width:75px;">$filc[codigocausa]</th>
   <th style="text-align:center; width:45px;">$filc[codorden]</th>

   <th style="text-align:center; width:50px;">$rowt[expediente]</th>
   <th style="text-align:center; width:50px;">$rowult[ultima_foja]</th>

   <th style="text-align:center; width:80px;">$filc[nomcausa]</th>
   <th style="text-align:center; width:185px;">$filc[Obser]</th>
   <th style="text-align:center; width:70px;">$filc[fechafin]</th>
   <th style=" width:150px;">$rowpres[detalle_presupuesto]</th>
   <th style=" width:200px;">$filc[infocarga]</th>
</tr>
</thead>
</table>
EOF;
