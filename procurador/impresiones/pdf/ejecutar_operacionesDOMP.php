...
<center>
<label>ORDENES PARA EJECUCIÓN</label>
</center>

<label>Procurador: $procnombre</label>
</form>
...
<tr nobr='true' >
   ...
   <td style='text-align:justify; width:150px;'> $rowpres[detalle_presupuesto]</td>
   <td style='text-align:justify; width:200px;'>$filc[infocarga]</td>
</tr>";
 }
