...
<html>
<head>
    <title>Lista Ordenes Pronunciadas Abogado</title>
...
<!--TABLA LISTA DE ORDENES PROCURADOR-->
    <div class="container">
    <h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES PRONUNCIADAS POR EL ABOGADO</h3>
...
<tbody>
 ...
 $idproc=$datos['id_procurador'];  //id_procurador CODIGO DEL PROCURADOR
  ...
  ini_set('date.timezone','America/La_Paz');
   ...
   $resul=$objorden->listarordenesDeProcuradorpronuncioabogadodeunacausaparaprocuradores($codigonuevocausa,$idproc);
