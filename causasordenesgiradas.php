...
<html>
<head>
    <title>Causas Ordenes Giradas</title>
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*1234567; 
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_giradas.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
