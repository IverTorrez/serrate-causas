...
<html>
<head>
    <title>Lista de Ordenes Conciliadas Contador ADMIN</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES DEL ADMINISTRADOR, CONCILIADAS POR EL CONTADOR</h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesDeAdminCuentasConciliadasDeunaCausa($codigonuevo);
