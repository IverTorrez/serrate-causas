...
<html>
<head>
    <title>Lista de Ordenes Dinero Entregado</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES DINERO ENTREGADO</h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesDineroEntregadoDeunaCausaAdmin($codigonuevo);
