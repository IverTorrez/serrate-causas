...
<input type="hidden" name="tipousuario" id="tipousuario" value="Admin">
 ...
 <input type="hidden" name="textiddemanedit" id="textiddemanedit" placeholder="id deman editar" value="<?php echo $codigonuevodeman; ?>">
    <div class="orden">
        <label>NOMBRE</label>               
        <input type="text" name="nombre" id="nombre" placeholder="Nombre.." autocomplete="off" required="" value="<?php echo $nombredeman; ?>">
    </div>
   ...
   <textarea style="display: none;" id="textultimodomsolotexto" name="textultimodomsolotexto"></textarea>
    ...
    <div class="orden">
        <label>FOJAS</label>
        <input type="text" name="foja" id="foja" autocomplete="off"  required="required" value="<?php echo $fojade; ?>">
    </div>
