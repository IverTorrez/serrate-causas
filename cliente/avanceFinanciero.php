            ...
            <ul>
                <li class="first_listleftadm"><a href="../cerrarSesion.php" class="main_menu_first">SALIR</a></li>
                 <li class="first_listleftadm"><a href="clienteCausas.php" class="main_menu_first ">CAUSAS ACTIVAS</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
                  <li class="first_listleftadm"><a href="avanceFinanciero.php?squart=<?php echo $codcausa; ?>"  class="main_menu_first main_current">AVANCE FINANCIERO</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
        ...
        <div id="portfolio_area">
            ...
            <div id="portfolio_menu">  
                <ul>
                    ...
                    <li style="float: right;"><button class="botones" style="text-align: center;" onclick="window.open('impresiones/tcpdf/pdf/avancefinanciero.php?codcausa=<?php echo $codcausa ?>')">IMPRIMIR</button></li>
                </ul>
                <ul></ul>
