...
?>
    ...
    <div id="header">
       ...
       <div id="main_menu_admin">
            <ul>
                ...
                <li class="first_listleftadm"><a href="avancefisico.php?squart=<?php echo $codcausa; ?>" class="main_menu_first main_current">AVANCE FISICO</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
  ...
  <div id="main_content">
    ...
    <div id="portfolio_menu">
                <ul>
                <li ><button class="botones" style="text-align: center;" onclick="window.open('impresiones/tcpdf/pdf/impresion_historigrama.php?codcausa=<?php echo $codcausa ?>')">IMPRIMIR</button></li>
               </ul>
               <br>
  ...
  <div class="container">
     ...
     <section class="responsive">
      <h3 style="color: #000000;font-size: 20px;text-align: center;font-family: fantasy;">AVANCE FISICO DE LA PRESENTE CAUSA</h3>
      <br>
      <!--TABLA 1-->
