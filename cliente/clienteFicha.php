...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="../resources/logoserrate3.jfif">
    ...
    <link rel="stylesheet" type="text/css" href="../resources/tablaCli.css">
...
<!-- MENU 1 -->
 <div id="header">
        ...
        <div id="main_menu_admin">
            ...
            <ul>
                 ...
                 <li class="first_listleftadm"><a href="clienteCausas.php" class="main_menu_first ">CAUSAS ACTIVAS</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
                  <li class="first_listleftadm"><a href="#containeravacefinaciero"  class="main_menu_first ">AVANCE FINANCIERO</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
  ...
  <br>
  <label>NOTA 1.- Para ver el AVANCE FISICO de su causa (historigrama), oprima el enlace “Avance Físico”</label><br>
  <label>NOTA 2.- Para ver el AVANCE FINANCIERO de su causa (Lista de órdenes), oprima el enlace “Avance Financiero”</label><br>
 ...
 <thead>     
  <tr>
    ...
    <th width="">NOMBRE DEL PROCESO</th>
    <th width="20%">ABOGADO</th>
    
    <th width="20%">PROCURADOR <br><p id="psubt">(POR DEFECTO)</th>
  </tr>
</thead>
<tbody>
...
<section class="responsive">
 ...
 <thead>     
  <tr>
    <th width="13%">FISIOLOGIA DEL TRIBUNAL</th>
    <th >NOMBRE DE TRIBUNAL</th>
    <th width="8%">VER UBICACION</th>
    <th width="8%">VER FOTO DE FACHADA</th>
    <th width="7%">PISO</th>
    <th width="10%"># DE EXP.</th>
    <th width="13%">EXPEDIENTE DIGITAL</th>
    <th width="13%">CODIGO JURIDICO</th>
  </tr>
</thead>
<tbody>
  <?php
...
<!-- inicio del container table -->
<div class="container" id="containeravacefinaciero">
...
<tbody>
  ...
  while ($filor=mysqli_fetch_object($resultor)) 
  {
    ...
    else
    {
     $backgroundfila='white'; 
      ...
      $mascara=$filor->idorden*10987654321;
      $encriptado=base64_encode($mascara);
    echo "<tr style='background: $backgroundfila'>";
       echo "<td><a href='orden.php?squart=$encriptado'>$filor->idorden</a> </td>";
  ...
  }/*FIN DEL WHILE QUE RRECORRE TODAS LAS ORDENES DE LA CAUSA*/
  ?>
