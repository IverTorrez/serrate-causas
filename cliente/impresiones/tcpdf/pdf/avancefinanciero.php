...
$pdf->SetFont('','',12);
$pdf->Cell(0, 0, 'AVANCE FINANCIERO  CAUSA: '.$codigocausa, 0, 1, 'C', 0, '', 1);
...
$pdf->SetFont('','',12);
$pdf->Cell(0, 0, 'DETALLES DE EGRESOS ', 0, 1, 'C', 0, '', 1);
...
$bloqueEgresosCab1=<<<EOF
<table border="0.1px">
  <thead>
     <tr id="formato">
    <th  rowspan="2" style="text-align:center; width:50px; background-color:#e8e8e8;"># DE ORDEN</th>
    <th rowspan="2"  style="text-align:center; width:235px; background-color:#e8e8e8;">CARGA DE INFORMACION</th>
    <th  rowspan="2" style="text-align:center; width:240px; background-color:#e8e8e8;">DESCARGA DE INFORMACION</th>
    <th  rowspan="2" style="text-align:center; width:70px; background-color:#e8e8e8;">FECHA DE FINALIZACION DE LA ORDEN</th>
    <th  colspan="2" style="text-align:center; width:120px; background-color:#e8e8e8;">PARAMETROS ELECTRONICO PARA COTIZAR ESTA ORDEN</th>
    <th  rowspan="2" style="text-align:center; width:50px; background-color:#e8e8e8;">COSTO JUDICIAL (Bs.)</th>
    <th rowspan="2" style="text-align:center; width:70px; background-color:#e8e8e8;">COSTO DE PROCURADURIA (Bs.)</th>
    <th rowspan="2" style="text-align:center; width:70px; background-color:#e8e8e8;">COSTO TOTAL DE LA ORDEN (Bs.)</th>
  </tr>
<tr id="formato">
  <th  style="text-align:center; width:60px; background-color:#e8e8e8;">NIVEL DE PRIORIDAD</th>
  <th style="text-align:center; width:60px; background-color:#e8e8e8;">PLAZO EN HORAS</th>
</tr>
  </thead>
...
EOF;
$pdf->writeHTML($bloqueEgresosCab1,false,false,false,false,'');
...
<tr style="page-break-inside: avoid;background-color: $backgroundfila;" nobr="true">
   ...
   <th style="text-align:center; width:60px;">$prioridadOrden</th>
...
$nameFile='AvanceFinanciero_'.$codigocausa.'.pdf';
$pdf->Output($nameFile);
