...
<html>
<head>
    <title>Lista de Ordenes Conciliadas Contador</title>
...
<h3 style="color: #000000;font-size: 25px;text-align: center;">LISTADO DE ORDENES CONCILIADAS POR EL CONTADOR</h3>    
    <br>
...
<?php
  ...
  $totalegreso=0;
   ...
   $resul=$objorden->listarordenesCuentasConciliadasDeunaCausaAdmin($codigonuevo);
