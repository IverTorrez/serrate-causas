...
<html>
<head>
    <title>Causas Dinero Entregado ADMIN</title>
    ...
    <div >
      <table width="100%">
        <tr>
          ...
          <td width="85%">
            <h3 style="color: #000000;font-size: 25px;">LISTADO DE CAUSAS CON ORDENES QUE TIENEN DINERO ENTREGADO DEL ADMINISTRADOR</h3>
          </td>
        </tr>
      </table>  
    </div>
...
<tbody>
 <?php
   $objcausa=new Causa();
   $resul=$objcausa->listarcausasconordenesdineroentregadoDeAdmin();
       ...
       echo "<tr>";
            ...
            $mascara=$fil->id_causa*1234567;
             $encriptado=base64_encode($mascara);
              echo "<td class='tdcod'><a href='ordenes_dineroentregado_admin.php?squart=$encriptado' onclick=funcionirficha($fil->id_causa)>$fil->codigo</a></td>";
